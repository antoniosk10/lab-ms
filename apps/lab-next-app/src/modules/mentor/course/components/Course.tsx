import BannerForm from '@modules/mentor/course/components/Banner'
import LessonModules from '@modules/mentor/course/components/LessonModules/LessonModules'
import { LessonResDto, ModuleResDto } from '@modules/mentor/course/dto'
import { Box, Grid, Typography } from '@mui/material'
import PageContainer, { PageContent } from '@src/components/PageContainer'
import { useCallback, useState } from 'react'
import { FormProvider, useForm } from 'react-hook-form'
import { v4 as uuidv4 } from 'uuid'
import { LessonContent } from '@modules/mentor/course/components/LessonContent/LessonContent'

import { LessonFields } from './LessonContent/LessonContentForm/LessonContentForm'
...
function Course({ modules, courseName }: Props) {
  ...
  const getLessonsByModuleId = useCallback(
    (moduleId: string): LessonResDto[] => {
      ...
      return (currentModule as ModuleResDto).lessons
    },
    [modulesForm]
  )
